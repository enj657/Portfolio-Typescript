  ...
  return (
    <section className='flex flex-1 p-4 md:pt-0 md:px-12 lg:pb-4 lg:pt-8' id='about'>
      <div className='flex flex-col justify-center'>
        ...
        <p className='mb-6 mt-4 text-center text-base md:text-left'>{`Hey, I'm Elle, a software engineer who loves creating fun websites. I got hooked on software engineering after a data analytics bootcamp in 2022.`}</p>

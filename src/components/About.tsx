  ...
  return (
    <section className='flex flex-1 p-4 md:p-8' id='about'>
      <div className='flex flex-col justify-center'>
        <h2 className='pb-3 text-2xl text-teal-500'>About</h2>
        <p className='mb-6 text-base'>{`Hey, I'm Elle, a web developer who loves creating awesome websites. I got hooked on web development after a data analytics bootcamp in 2022.`}</p>

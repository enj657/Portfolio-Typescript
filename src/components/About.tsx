  ...
  return (
    <section className='flex flex-1 p-4 md:px-12 md:py-8' id='about'>
      <div className='flex flex-col justify-center'>
        ...
        <p className='my-6 text-base'>{`Hey, I'm Elle, a web developer who loves creating fun websites. I got hooked on web development after a data analytics bootcamp in 2022.`}</p>

...
const Logo3: React.FC<Logo3Props> = ({
  hoverState4,
  setHoverState4,
  primaryPickerColor,
  ...
  return (
    <motion.svg
      ...
      whileHover='hover' // Use the 'hover' state defined in the svgVariants
      ...
      onMouseOver={() => setHoverState4(true)}
      onMouseOut={() => setHoverState4(false)}
      strokeMiterlimit='10'
      strokeLinecap='round'
